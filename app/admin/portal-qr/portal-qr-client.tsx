...
export default function PortalQRClient() {
  return (
    <>
      {/* Print button */}
      ...
      {/* Print styles injected via a style tag in client component — allowed here */}
      <style>{`
        @media print {
...
function Card() {
  return (
    <div
      ...
      className="bg-white rounded-2xl overflow-hidden shadow-lg print:shadow-none print:rounded-xl print:border-2 print:border-dashed print:border-gray-300"
    >
      {/* Green header */}
      <div
      ...
      <div className="px-6 py-5 flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          ...
          <p className="text-lg font-bold" style={{ color: '#006A4E' }}>
            Customer Portal
          </p>
        </div>
