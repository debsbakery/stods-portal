    ...
    >
      ...
      <div className="px-6 py-5 flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          ...
          <p className="text-lg font-bold" style={{ color: '#3E1F00' }}>Customer Portal</p>
        </div>

        {/* QR Code */}
        <div className="p-3 rounded-xl border-2" style={{ borderColor: '#3E1F00' }}>
        ...
        <div className="w-full text-center">
          ...
          <p className="text-xs font-mono font-bold" style={{ color: '#C4A882' }}>
